...
[XGBRegressor(base_score=0.5, booster='gbtree', colsample_bylevel=1,
             ...
             validate_parameters=1, verbosity=None), XGBRegressor(base_score=0.5, booster='gbtree', colsample_bylevel=1,
             colsample_bynode=1, colsample_bytree=1, gamma=0, gpu_id=-1,
             importance_type='gain', interaction_constraints='',
             min_child_weight=1, missing=nan, monotone_constraints='()',
             n_estimators=100, n_jobs=6, num_parallel_tree=1,
...
for i in range(len(model.estimators_)) :
    ...
    for thresh in threshold :
        ...
        submit.to_csv("./dacon/comp1/submit/submit_XGB_RGS_%i_%.4f.csv"%(i, mae), header = ["hhb", "hbo2", "ca", "na"], index = True, index_label = "id")
