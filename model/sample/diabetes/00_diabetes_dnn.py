...
checkpointpath = './model/sample/diabetes/diabetes_check-{epoch:02d}-{loss:.4f}.hdf5'
...
model.save_weights('./model/sample/diabetes/diabetes_save_weight.h5')
...
epo 30, batch 1
RSME :  55.27418312379514
R2 :  0.5158958980510128
'''